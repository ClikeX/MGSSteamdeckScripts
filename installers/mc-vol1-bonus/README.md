# Master Collection Vol. 1 Bonus Content Installer

Installs MGSM2Fix for **Metal Gear Solid: Master Collection Vol. 1 Bonus
Content** (Steam AppID `2306740`) on Steam Deck or desktop Linux. This title
contains the NES versions of **Metal Gear** and **Snake's Revenge**.
...
```bash
./installers/mc-vol1-bonus/install-mc-vol1-bonus.bash --set-launch-options
```
...
```bash
./installers/mc-vol1-bonus/install-mc-vol1-bonus.bash --uninstall
```
